Arch is an **intelligent proxy server designed for prompts** - to help you protect, observe, and build agentic apps by simply integrating (existing) APIs. Focus on what matters most. Built by the contributors of [Envoy Proxy](https://www.envoyproxy.io/) with the belief that:
